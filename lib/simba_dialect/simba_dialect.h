/** @file
 *  @brief MAVLink comm protocol generated from simba_dialect.xml
 *  @see http://mavlink.org
 */
#pragma once
#ifndef MAVLINK_SIMBA_DIALECT_H
#define MAVLINK_SIMBA_DIALECT_H

#ifndef MAVLINK_H
    #error Wrong include order: MAVLINK_SIMBA_DIALECT.H MUST NOT BE DIRECTLY USED. Include mavlink.h from the same directory instead or set ALL AND EVERY defines from MAVLINK.H manually accordingly, including the #define MAVLINK_H call.
#endif

#define MAVLINK_SIMBA_DIALECT_XML_HASH 6337334848159210071
...
#define MAVLINK_ENABLED_SIMBA_DIALECT
...
#if MAVLINK_SIMBA_DIALECT_XML_HASH == MAVLINK_PRIMARY_XML_HASH
