/** @file
 *    @brief MAVLink comm protocol testsuite generated from simba_dialect.xml
 *    @see https://mavlink.io/en/
 */
#pragma once
#ifndef SIMBA_DIALECT_TESTSUITE_H
#define SIMBA_DIALECT_TESTSUITE_H
...
static void mavlink_test_simba_dialect(uint8_t, uint8_t, mavlink_message_t *last_msg);

static void mavlink_test_all(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{

    mavlink_test_simba_dialect(system_id, component_id, last_msg);
}
#endif
...
static void mavlink_test_simba_dialect(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
...
#endif // __cplusplus
#endif // SIMBA_DIALECT_TESTSUITE_H
