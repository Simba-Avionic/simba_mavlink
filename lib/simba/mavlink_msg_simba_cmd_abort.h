#pragma once
// MESSAGE SIMBA_CMD_ABORT PACKING

#define MAVLINK_MSG_ID_SIMBA_CMD_ABORT 145
...
#define MAVLINK_MSG_ID_SIMBA_CMD_ABORT_MIN_LEN 1
...
/**
 * @brief Pack a simba_cmd_abort message
                               ...
                               uint8_t value)
{
    ...
    msg->msgid = MAVLINK_MSG_ID_SIMBA_CMD_ABORT;
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_SIMBA_CMD_ABORT_MIN_LEN, MAVLINK_MSG_ID_SIMBA_CMD_ABORT_LEN, MAVLINK_MSG_ID_SIMBA_CMD_ABORT_CRC);
}
                               ...
                               uint8_t value)
{
    ...
    return mavlink_finalize_message_buffer(msg, system_id, component_id, _status, MAVLINK_MSG_ID_SIMBA_CMD_ABORT_MIN_LEN, MAVLINK_MSG_ID_SIMBA_CMD_ABORT_LEN, MAVLINK_MSG_ID_SIMBA_CMD_ABORT_CRC);
#else
    return mavlink_finalize_message_buffer(msg, system_id, component_id, _status, MAVLINK_MSG_ID_SIMBA_CMD_ABORT_MIN_LEN, MAVLINK_MSG_ID_SIMBA_CMD_ABORT_LEN);
#endif
}

/**
 * @brief Pack a simba_cmd_abort message on a channel
 * @param system_id ID of this system
 * @param component_id ID of this component (e.g. 200 for IMU)
                                   ...
                                   uint8_t value)
{
    ...
    msg->msgid = MAVLINK_MSG_ID_SIMBA_CMD_ABORT;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_SIMBA_CMD_ABORT_MIN_LEN, MAVLINK_MSG_ID_SIMBA_CMD_ABORT_LEN, MAVLINK_MSG_ID_SIMBA_CMD_ABORT_CRC);
}

/**
 * @brief Encode a simba_cmd_abort struct
 *
 * @param system_id ID of this system
 * @param component_id ID of this component (e.g. 200 for IMU)
 * @param msg The MAVLink message to compress the data into
 * @param simba_cmd_abort C-struct to read the message contents from
 */
...
/**
 * @brief Encode a simba_cmd_abort struct on a channel
 *
 * @param system_id ID of this system
 * @param component_id ID of this component (e.g. 200 for IMU)
 * @param chan The MAVLink channel this message will be sent over
...
/**
 * @brief Encode a simba_cmd_abort struct with provided status structure
 *
 * @param system_id ID of this system
 * @param component_id ID of this component (e.g. 200 for IMU)
 * @param status MAVLink status structure
...
#if MAVLINK_MSG_ID_SIMBA_CMD_ABORT_LEN <= MAVLINK_MAX_PAYLOAD_LEN
/*
...
// MESSAGE SIMBA_CMD_ABORT UNPACKING
...
/**
 * @brief Decode a simba_cmd_abort message into a struct
 *
 * @param msg The message to decode
 * @param simba_cmd_abort C-struct to decode the message contents into
 */
static inline void mavlink_msg_simba_cmd_abort_decode(const mavlink_message_t* msg, mavlink_simba_cmd_abort_t* simba_cmd_abort)
{
    ...
    memcpy(simba_cmd_abort, _MAV_PAYLOAD(msg), len);
#endif
}
