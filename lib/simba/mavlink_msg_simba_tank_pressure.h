...
#define MAVLINK_MSG_ID_SIMBA_TANK_PRESSURE_LEN 2
#define MAVLINK_MSG_ID_SIMBA_TANK_PRESSURE_MIN_LEN 2
#define MAVLINK_MSG_ID_70_LEN 2
#define MAVLINK_MSG_ID_70_MIN_LEN 2

#define MAVLINK_MSG_ID_SIMBA_TANK_PRESSURE_CRC 149
#define MAVLINK_MSG_ID_70_CRC 149
...
#define MAVLINK_MESSAGE_INFO_SIMBA_TANK_PRESSURE { \
    ...
    "SIMBA_TANK_PRESSURE", \
    1, \
    {  { "pressure", NULL, MAVLINK_TYPE_UINT16_T, 0, 0, offsetof(mavlink_simba_tank_pressure_t, pressure) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_SIMBA_TANK_PRESSURE { \
...
{
    return mavlink_msg_simba_tank_pressure_pack(system_id, component_id, msg, simba_tank_pressure->pressure);
}
...
{
    return mavlink_msg_simba_tank_pressure_pack_chan(system_id, component_id, chan, msg, simba_tank_pressure->pressure);
}
...
{
    return mavlink_msg_simba_tank_pressure_pack_status(system_id, component_id, _status, msg,  simba_tank_pressure->pressure);
}
...
static inline void mavlink_msg_simba_tank_pressure_send(mavlink_channel_t chan, uint16_t pressure)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_SIMBA_TANK_PRESSURE_LEN];
    _mav_put_uint16_t(buf, 0, pressure);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_simba_tank_pressure_send(chan, simba_tank_pressure->pressure);
#else
 ...
 */
static inline void mavlink_msg_simba_tank_pressure_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint16_t pressure)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static inline uint16_t mavlink_msg_simba_tank_pressure_get_pressure(const mavlink_message_t* msg)
{
