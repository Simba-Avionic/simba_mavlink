...
#define MAVLINK_MSG_ID_SIMBA_CMD_HOLD_CRC 193
#define MAVLINK_MSG_ID_144_CRC 193
...
#define MAVLINK_MESSAGE_INFO_SIMBA_CMD_HOLD { \
    ...
    "SIMBA_CMD_HOLD", \
    1, \
    {  { "value", NULL, MAVLINK_TYPE_UINT8_T, 0, 0, offsetof(mavlink_simba_cmd_hold_t, value) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_SIMBA_CMD_HOLD { \
...
{
    return mavlink_msg_simba_cmd_hold_pack(system_id, component_id, msg, simba_cmd_hold->value);
}
...
{
    return mavlink_msg_simba_cmd_hold_pack_chan(system_id, component_id, chan, msg, simba_cmd_hold->value);
}
...
{
    return mavlink_msg_simba_cmd_hold_pack_status(system_id, component_id, _status, msg,  simba_cmd_hold->value);
}
...
static inline void mavlink_msg_simba_cmd_hold_send(mavlink_channel_t chan, uint8_t value)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_SIMBA_CMD_HOLD_LEN];
    _mav_put_uint8_t(buf, 0, value);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_simba_cmd_hold_send(chan, simba_cmd_hold->value);
#else
 ...
 */
static inline void mavlink_msg_simba_cmd_hold_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t value)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field value from simba_cmd_hold message
 *
 * @return  Ignoring field
 */
static inline uint8_t mavlink_msg_simba_cmd_hold_get_value(const mavlink_message_t* msg)
{
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    simba_cmd_hold->value = mavlink_msg_simba_cmd_hold_get_value(msg);
#else
